;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="1e06fc282ea39cdaa659d240e597fe9f";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["7KqLPwtqjpKy"]={appId:"U7qJvtD8fdSv",scope:{}};;CloudflareApps.installs["7KqLPwtqjpKy"].options={"backgroundColor":"#23272A","backgroundOpacity":0.74,"buttonBorderColor":"#000000","buttonColor":"#ffffff","buttonHoverColor":"#ffffff","buttonHoverTextColor":"#000000","buttonLocation":"right","buttonText":"GO' MELDING!","buttonTextColor":"#000000","buttonTextSize":{"unit":"em","value":0.9},"cookieLifetime":true,"location":"bottom","message":"Denne hjemmeside benytter cookies for at forbedre din oplevelse. Læs om vores Privatlivspolitik","textColor":"#ffffff","textLink":"her","textLinkColor":"#497cc9","textLinkHoverColor":"#559bbd","textLinkUrl":"https://socialrp.dk/privacy","textSize":{"unit":"em","value":0.8}};;CloudflareApps.installs["7KqLPwtqjpKy"].URLPatterns=["^socialrp.dk/?.*$","^www.socialrp.dk/?.*$"];;CloudflareApps.installs["bKfqvl8Nor3U"]={appId:"t8Sk01am_9iA",scope:{}};;CloudflareApps.installs["bKfqvl8Nor3U"].options={"advancedOptions":{"disableOnAJAX":false,"disableOnPushState":false},"color":"orange","hidePage":false,"showAdvanced":false,"theme":"flash"};;CloudflareApps.installs["rHrBeEAHGy2I"]={appId:"Ek_0U0d0YWhZ",scope:{}};;CloudflareApps.installs["rHrBeEAHGy2I"].options={};;CloudflareApps.installs["rHrBeEAHGy2I"].URLPatterns=["^socialrp.dk/Apply/whitelist/?.*$","^www.socialrp.dk/Apply/whitelist/?.*$"];;if(CloudflareApps.matchPage(CloudflareApps.installs['bKfqvl8Nor3U'].URLPatterns)){(function(){var AjaxMonitor,Bar,DocumentMonitor,ElementMonitor,ElementTracker,EventLagMonitor,Evented,Events,NoTargetError,Pace,RequestIntercept,SOURCE_KEYS,Scaler,SocketRequestTracker,XHRRequestTracker,animation,avgAmplitude,bar,cancelAnimation,cancelAnimationFrame,defaultOptions,extend,extendNative,getFromDOM,getIntercept,handlePushState,ignoreStack,init,now,options,paceHideStyle,requestAnimationFrame,result,runAnimation,scalers,shouldIgnoreURL,shouldTrack,source,sources,uniScaler,_WebSocket,_XDomainRequest,_XMLHttpRequest,_i,_intercept,_len,_pushState,_ref,_ref1,_replaceState,__slice=[].slice,__hasProp={}.hasOwnProperty,__extends=function(child,parent){for(var key in parent){if(__hasProp.call(parent,key))child[key]=parent[key];}function ctor(){this.constructor=child;}ctor.prototype=parent.prototype;child.prototype=new ctor();child.__super__=parent.prototype;return child;},__indexOf=[].indexOf||function(item){for(var i=0,l=this.length;i<l;i++){if(i in this&&this[i]===item)return i;}return-1;};defaultOptions={hidePage:false,catchupTime:100,initialRate:.03,minTime:250,ghostTime:100,maxProgressPerFrame:20,easeFactor:1.25,startOnPageLoad:true,restartOnPushState:true,restartOnRequestAfter:500,target:'body',elements:{checkInterval:100,selectors:['body']},eventLag:{minSamples:10,sampleCount:3,lagThreshold:3},ajax:{trackMethods:['GET'],trackWebSockets:true,ignoreURLs:[]}};now=function(){var _ref;return(_ref=typeof performance!=="undefined"&&performance!==null?typeof performance.now==="function"?performance.now():void 0:void 0)!=null?_ref:+(new Date);};requestAnimationFrame=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame;cancelAnimationFrame=window.cancelAnimationFrame||window.mozCancelAnimationFrame;if(requestAnimationFrame==null){requestAnimationFrame=function(fn){return setTimeout(fn,50);};cancelAnimationFrame=function(id){return clearTimeout(id);};}
...
module.exports=lStorage;}]);};(function(){try{var link=document.createElement('link');link.rel='stylesheet';link.href='data:text/css;charset=utf-8;base64,';document.getElementsByTagName('head')[0].appendChild(link);}catch(e){}})();(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/XKxzjhJRv2RHIbx9D8HwefWFxj4.js';document.head.appendChild(script);})();